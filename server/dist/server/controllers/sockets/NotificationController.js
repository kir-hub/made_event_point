...
var NotificationController = /*#__PURE__*/function (_WebSocket) {
  _inherits(NotificationController, _WebSocket);
  ...
  _createClass(NotificationController, [{
    key: "emitEntryCreated",
    value: function emitEntryCreated(target) {
      this.io.to(target).emit(CONSTANTS.NOTIFICATION_ENTRY_CREATED);
    }
  }, {
    key: "emitChangeMark",
    value: function emitChangeMark(target) {
      this.io.to(target).emit(CONSTANTS.NOTIFICATION_CHANGE_MARK);
    }
  }, {
    key: "emitChangeOfferStatus",
    value: function emitChangeOfferStatus(target, message, contestId) {
